...
class Messenger(object):
    ...
    def write_greeting(self, channel_id, user_id):
        greetings = ['Hi', 'Hello', 'Nice to meet you', 'Howdy', 'Salutations']
                ...
                'I have to admit that I frequently got graded as “needs improvement” as a parent. Yes, there was the time I forgot to pick up my son at school, and a time I put him on a sled in a snow storm attached to a dog and the dog took off across Valley Forge Park, and a time I forgot his duffel bag for a ski trip, and the time . . . well you get it.',
                   'This is a great moment. You are beginning a journey that will be life-altering.', 'Fortunately, medicine is an egalitarian profession—hard work and grit are the currency.', 'Each of you has many assets that you should understand and maximize.',
